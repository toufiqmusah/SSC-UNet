...
class SwinUNETR(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            do_deep_supervision: whether to enable deep supervision. Default is False.
    ...
    def forward(self, x_in):
        ...
        if self.deep_supervision:
            ...
            ds_seg1 = self.ds_seg_from_dec1(dec1)  # Half res
            ds_seg2 = self.ds_seg_from_dec2(dec2)  # Quarter res
            ds_seg3 = self.ds_seg_from_dec3(dec3)  # Eighth res
            return (logits, ds_seg1, ds_seg2, ds_seg3)
        else:
            return logits
